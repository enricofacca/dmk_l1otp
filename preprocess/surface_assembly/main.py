...
if ( flag_grid != 'use'):
    ...
    points, vertices, mesh, sources, sinks, kappas,tdens0_functions, optdens_functions = ex_grid.example_grid(flag_grid,length,extra_grid)    
...
# subgrid quanties
#
print ('Building subgrid variables')
